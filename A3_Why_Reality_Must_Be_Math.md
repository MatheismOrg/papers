...
Under algorithmic probability, elegance is short description. Theories defended on aesthetic grounds must meet the same criterion. String theory landscape-selection, requiring at least 1,661 bits to index one vacuum from 10^500, has so far failed its own aesthetic and parsimony criteria on the same grounds (Bernstein, 2026g). The theory that explains the most with the least specification wins.
