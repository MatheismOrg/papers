...
Algorithmic probability (Solomonoff, 1964; Schmidhuber, 2000) states that a mathematical structure's measure is governed by its algorithmic probability: P(S) ∝ 2^(−K(S)), where K(S) is the Kolmogorov complexity of its shortest generating description. Algorithmic probability follows from the thesis that reality is identical to mathematical structure (Bernstein, 2026c) and that algorithmic probability is the natural measure over structure-space (Schmidhuber, 2000; Bernstein, 2026d).

Five results follow from algorithmic probability: (1) Occam's Razor is a theorem about the statistics of existence; (2) Algorithmic probability selects for universes whose physics takes variational form, grounding the Principle of Least Action as a selection effect across structure-space; (3) cosmological fine-tuning dissolves; (4) the thermodynamic arrow of time is grounded rather than postulated; (5) superdeterminism is rehabilitated as a serious interpretation of quantum mechanics. A sixth result, the arrow of computation, provides the structural foundation for the time asymmetry algorithmic probability quantifies: the inverse of 1+1=2 does not exist, yielding an irreversibility that holds without reference to measure or probability. algorithmic probability's time arrow depends on this irreversibility: end states have high K precisely because many-to-one functions ran forward. Under mathematical monism this structural fact is as fundamental as unitarity. Together with algorithmic probability, it strengthens the Many-Worlds Interpretation: MWI is the only framework where the substrate stays reversible while the arrow exists at the function level. Further consequences extend beyond physics and are developed in companion papers. That convergent results span epistemology, dynamics, cosmology, thermodynamics, computation, quantum foundations, variational dynamics, and variational geometry constitutes cumulative evidence for the position.

**Keywords:** algorithmic probability, Kolmogorov complexity, algorithmic probability, Occam's Razor, arrow of time, superdeterminism, Many-Worlds, variational dynamics, variational geometry, mathematical monism
...
Each was previously treated as a separate puzzle. Mathematical monism unifies them. The computational arrow is the structural foundation. Algorithmic probability quantifies its consequence. Together they converge on a single framework.
